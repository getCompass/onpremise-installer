...
const LANG_CONFIG: LangConfig = {
    ru: {
        ...
        install_page: {
            header: {
                yandex_title: "Compass на сервере Yandex Cloud",
                default_title: "Compass On-premise",
                support_title: "Служба поддержки",
                documentation_title: "Документация",
                support_dialog: {
                    title: "Нужна помощь?",
                    yandex_desc: "Напишите нам на support-cloud@getcompass.ru или свяжитесь в мессенджере.",
                    default_desc: "Напишите нам на support@getcompass.ru или свяжитесь в мессенджере.",
                    button: "Telegram"
                },
            },
            configure: {
                ...
                auth_block: {
                    ...
                    mail_2fa_title: "Двухфакторная авторизация",
                ...
                confirm_block: {
                    ...
                    yandex_offer_desc: "Я согласен с условиями политики конфиденциальности и публичной оферты на право использования ПО Compass в Yandex Cloud",
                    default_offer_desc: "Я согласен с условиями политики конфиденциальности и публичной оферты на право использования ПО Compass",
            ...
            hints: {
                ...
                yandex_domain_input_pt1: "Для установки Compass On-premise требуется публично-доступное доменное имя, которое ведет на сервер. Перед установкой укажите в А-записи домена IP-адрес сервера. Узнать\nIP-адрес можно в консоли Yandex Cloud.",
                default_domain_input_pt1: "Для установки Compass On-premise требуется публично-доступное доменное имя, которое ведет на сервер. Перед установкой укажите в А-записи домена IP-адрес сервера.",
                ...
                mail_block_title: "Вы можете настроить отправку писем для двухфакторной аутентификации через собственный SMTP-сервер, либо воспользоваться одним из публичных почтовых сервисов. Ознакомьтесь с инструкциями по настройке в нашей официальной документации:",
                mail_block_title_link_gmail: "Подключение почты Gmail;",
                mail_block_title_link_yandex: "Подключение почты Яндекс.",
                mail_title: "Параметры имени пользователя и пароля могут быть не заполнены, если SMTP-сервер работает без аутентификации.",
                ...
                mail_2fa_title: "Требуется ли код подтверждения с почты при регистрации и авторизации пользователей. Вы сможете включить и настроить двухфакторную аутентификацию после установки.",
            },
        },
    },
    en: {},
