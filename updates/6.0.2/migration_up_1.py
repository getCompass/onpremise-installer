...
# конфигурация версий для фич - Прочитанные и группа-канал
PLATFORM_FEATURES = {
    'Версия с включением функционала "Прочитанные и группа-канал"': {
        'ios': '1122219',
        'android': '100051803'
    },
}
...
def main():
    ...
    feature_name = 'Версия с включением функционала "Прочитанные и группа-канал"'
