...
import re, socket, yaml, argparse, readline, string, random, pwd, os, shutil
...
config_path = Path(script_dir + "/../../configs/siem.yaml")

# папка, где находятся шаблоны конфигов
config_tpl_path = Path(script_dir + "/../../yaml_template/configs/siem.tpl.yaml")
